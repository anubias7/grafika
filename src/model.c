...
void init_entities(World* world) {
	...
	// beachball
	load_model("models//Beachball.obj", &world->beachball.model);
	world->beachball.texture = load_texture("textures//Beachball.jpg");
	init_object(&world->beachball, 30, 110, -40);
	
	// soccerball
	load_model("models//Soccerball.obj", &world->soccerball.model);
	world->soccerball.texture = load_texture("textures//Soccerball.jpg");
	init_object(&world->soccerball, -40, 110, -20);
	
	// golfball
	load_model("models//golf.obj", &world->golf.model);
	world->golf.texture = load_texture("textures//golf.jpg");
	init_object(&world->golf, 40, 110, 12);
	
	// table
	load_model("models//Table.obj", &world->table.model);
	world->table.texture = load_texture("textures//Table.jpg");
	init_object(&world->table, 0, 0, 0);
